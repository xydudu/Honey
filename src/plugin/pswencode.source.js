...
honey.def(function( H ) {
    ...
    H.encodePassword = function ( input ) {
        var rsa_n = "";
        setMaxDigits(131);
        input = NonceAndLivetime() + input;
        return encryptedString(new RSAKeyPair("10001", '', rsa_n), input);
    }

    function NonceAndLivetime() {
