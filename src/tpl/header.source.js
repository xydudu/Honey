...
honey.def(function(H) {
    ...
    H.headerTpl = {
        basic: '<div class="mod-snav clearfix">'
            + '<div class="topnav">'
            + '<div class="topnav-l">'
            + '<span class="home"><a href="//hunantv.com" >金鹰网首页</a></span>'
            + '<span class="mobile"><a href="//hunantv.com/app" >手机客户端</a></span>'
            + '</div>'
        ...
        login: '<form action="http://spp.hunantv.com/passport/service.php?action=login"'
            ...
            + '<a href="http://passport2.hunantv.com/index.php?ac=findpass" class="forget">忘记密码</a>'
            + '</p>'
            + '</div>'
            + '<div class="cb-r">'
