...
honey.def(function(H) {
    ...
    H.headerTpl = {
        basic: '<div class="mod-snav clearfix">'
            + '<div class="topnav">'
            + '<div class="topnav-l">'
            + '<span class="home"><a href="//hunantv.com" target="_blank" >金鹰网首页</a></span>'
            + '<span class="mobile"><a href="//hunantv.com/app" target="_blank"  >手机客户端</a></span>'
            + '</div>'
            + '<div class="topnav-r" id="top-login-userinfo">'
            + '<div class="not-login">'
            + '<a href="/login" target="_blank" >新用户注册</a>'
